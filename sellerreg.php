		...
		<div class="container">
			<div class="agileits_breadcrumbs_left">
				<ul>
					...
					<li>Cafeterian Registration</li>
				</ul>
			</div>
			<div class="agileits_breadcrumbs_right">
				<h2>Cafeterian Registration</h2>
			</div>
...
<form class="well form-horizontal" action="addseller.php" method="post" id="contact_form" enctype="multipart/form-data">
<fieldset>


<legend><center><h3 class="agileits_head">Cafeterian Registration</h3></center></legend>
...
<div class="form-group">
  ...
  <input  name="fname" placeholder="First Name" class="form-control"  type="text" pattern="[A-Za-z]{1,15}" title="Enter Your First Name Properly ex:'Jemiy' " required>
  </div>
  </div>
</div>
