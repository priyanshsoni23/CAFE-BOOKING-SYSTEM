...
<div class="page-container">
    ...
    <form action="edittutor.php" method="POST">
    <button class="btn-primary btn" style="float: right;text-align:center  " name="sumbitbtn" >Update</button>



    <h2 style="text-align:center; color:#1b93e1"> Seller Profile </h2>

    <?php

    $con=mysqli_connect("localhost","root","","cattle");

    $str="select*from sellerregistration where sellerid = ".$_GET['sellerid'];
    $result= mysqli_query($con,$str);
    $row=mysqli_fetch_assoc($result);
    $id=$row['sellerid'];

   // echo "<div><img src='profileimages/".$_SESSION['pic']." ></div>";
   echo "<div style='text-align:center;padding-bottom:10px;padding-right:50px'><img class='img-circle profile-img' height=110 width=120 src='http://localhost/cattle/seller/$row[file]'></div>";
