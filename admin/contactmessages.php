...
?>
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Contact Messages</li>
            </ol>
	 ...
	 <th> Delete </th>
					 ...
					 <?php
							...
							while($row = mysqli_fetch_array($result))
							{
								...
								echo "<td> <a href = 'deletemessage.php?contactid=".$row['contactid']."'>Delete </a> </td>";
								echo "</tr>";
