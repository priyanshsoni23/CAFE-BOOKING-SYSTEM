...
?>
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Pending Tutors</li>
            </ol>
<div class="grid-form1">
<h3 id="form-horizontal">Pending Tutors</h3>
<?php $con = mysqli_connect ("localhost","root","","cattle");
	 ...
	 <th> Action </th>
					 ...
					 <?php
							...
							while($row = mysqli_fetch_array($result))
							{
								...
								echo "<td><img src='http://localhost/cattle/seller/$row[file]' border=3 height=100 width=100></img></td>";

								echo "<td> <a href = 'viewtutorinfo.php?sellerid=".$row['sellerid']."'>Edit </a> </td>";
								echo "</tr>";
