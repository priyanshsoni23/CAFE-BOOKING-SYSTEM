        ...
        <div class="left-content">
            <div class="mother-grid-inner">
                ...
                <div class="sidebar-menu">
                    ...
                    <div class="menu">
                        <ul id="menu">
                            <li><a href="home.php"><i class="glyphicon glyphicon-home"></i><span>Admin Home</span>
                            ...
                            <li id="menu-academico"><a href="#"><i class="fa fa-list-ul"
                                ...
                                <ul id="menu-academico-sub">
                                    <li id="menu-academico-avaliacoes"><a href="registeredseller.php">Registered
                                            Cafeterian</a></li>
                                    <li id="menu-academico-avaliacoes"><a href="registeredbuyer.php">Registered
                                            User</a></li>
                                    </li>
                                    <li id="menu-academico-avaliacoes"><a href="bookorder.php">Book Order</a></li>
                                    </li>
                                </ul>
                            </li>

                            <li><a href="pendingseller.php"><i class="fa fa-pencil-square-o"></i> <span>Pending Cafeterian</span>
                                    <div class="clearfix"></div>
                                </a></li>
                                ...
                                <li><a href="viewfeedback.php"><i class="fa fa-pencil"></i> <span>View Feedback</span>
                                    <div class="clearfix"></div>
                                </a></li>
