...
?>
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Reports<i class="fa fa-angle-right"></i>Registered Students</li>
            </ol>
	 ...
	 <th> Photo </th>
					 ...
					 <?php
							...
							while($row = mysqli_fetch_array($result))
							{
								...
								echo "<td><img src='http://localhost/cattle/buyer/$row[file]' border=3 height=100 width=100></img></td>";
