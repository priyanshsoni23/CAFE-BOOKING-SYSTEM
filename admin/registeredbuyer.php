...
?>
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Reports<i class="fa fa-angle-right"></i>Registered User</li>
            </ol>
<div class="page-container">
 	    ...
 	    <div class="grid-form1">
			 <?php $con = mysqli_connect ("localhost","root","","cafeterian");
							$str = "select * from buyerregistration ";
                            $result = mysqli_query($con,$str);
                            $number = mysqli_num_rows($result);
                            echo"<h4 style='text-align:right'>Number of User found: $number</h4>";  ?>
<hr>
	 ...
	 <th> Photo </th>
					 ...
					 <?php
							...
							while($row = mysqli_fetch_array($result))
							{
								...
								echo "<td><img src='http://localhost/cafeterian/buyerpic/$row[file]' border=3 height=100 width=100></img></td>";
