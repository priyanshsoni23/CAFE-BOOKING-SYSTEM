...
<div class="page-container">
    ...
    <h2 style="text-align:center; color:#1b93e1"> Cafeterian Profile </h2>
    <?php
   ...
   echo "<div style='text-align:center;padding-bottom:10px;padding-right:50px'><img class='img-circle profile-img' height=110 width=120 src='http://localhost/cafeterian/sellerpic/$row[file]'></div>";
