...
echo "194*228<img src='http://localhost/cafeterian/seller/cafe/$row[photo]' class='img-responsive'>";
echo "</div>";
echo "</div>";
...
echo "</a>";
echo "<a href='#'>";
echo "<span>".$row['capacity']." Person</span>";
echo "</a>";             
echo "</h5>";
...
echo "<a href='TxnTest.php?cafeid=".$row['cafeid']."&sellerid=".$row['sellerid']."&amt=".$row['price']."' class='btn btn-danger'>Buy Now</a>";
echo "<a href='cafeinfo.php?cafeid=".$row['cafeid']."' class='btn btn-info'>View Cafe</a>";
echo "</div>";
echo "</div>";
echo "</div>";
echo "</div>";
