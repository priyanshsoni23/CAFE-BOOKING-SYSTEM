...
echo "<div class='prod-info-main prod-wrap clearfix'>";
echo "<div class='row'>";
echo "<div class='col-md-5 col-sm-12 col-xs-12'>";
echo "<div class='product-image'>";
echo "194*228<img src='http://localhost/cafeterian/seller/cattle/$row[image]' class='img-responsive'>";
echo "</div>";
echo "</div>";
echo "<div class='col-md-7 col-sm-12 col-xs-12'>";
echo "<div class='product-deatil'>";
echo "<h5 class='name'>";
echo "<a href='#'>";
echo $row['title'];
echo "</a>";
echo "<a href='#'>";
echo "<span>".$row1['name']."</span>";
echo "</a>";             
echo "</h5>";
echo "<p class='price-container'>";
echo "<span>".$row['price']."</span>";
echo "</p>";
echo "<span class='tag1'></span>"; 
echo "</div>";
echo "<div class='description'>";
echo "<p>".$row['description']."</p>";
echo "</div>";
echo "<div class='product-info smart-form'>";
echo "<div class='row'>";
echo "<div class='col-md-12'>"; 
echo "<a href='TxnTest.php?cattleid=".$row['cattleid']."&sellerid=".$row['sellerid']."&amt=".$row['price']."' class='btn btn-danger'>Buy Cattle</a>";
echo "<a href='cattleinfo.php?cattleid=".$row['cattleid']."' class='btn btn-info'>View Cattle</a>";
echo "</div>";
echo "</div>";
echo "</div>";
echo "</div>";
